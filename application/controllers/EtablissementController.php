    ...
    public function editAction()
    {
        ...
        if($this->_request->isPost()) {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error','title' => '','message' => 'L\'établissement n\'a pas été mis à jour. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
        }
    }
    ...
    public function addAction()
    {
        ...
        if($this->_request->isPost()) {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error','title' => '','message' => 'L\'établissement n\'a pas été ajouté. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
        }
    ...
    public function editDescriptifAction()
    {
        ...
        if($this->_request->isPost())
        {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error', 'title' => 'Mise à jour annulée', 'message' => 'Les descriptifs n\'ont pas été mis à jour. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
    ...
    public function editTextesApplicablesAction()
    {
        ...
        if($this->_request->isPost()) {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error','title' => 'Mise à jour annulée','message' => 'Les textes applicables n\'ont pas été mis à jour. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
    ...
    public function addPieceJointeAction()
    {
        ...
        if($this->_request->isPost())
        {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error', 'title' => 'Mise à jour annulée', 'message' => 'La pièce jointe n\'a pas été ajoutée. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
    ...
    public function deletePieceJointeAction()
    {
        ...
        if($this->_request->isGet())
        {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error', 'title' => 'Suppression annulée', 'message' => 'La pièce jointe n\'a pas été supprimée. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
    ...
    public function addContactAction()
    {
        ...
        if($this->_request->isPost())
        {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error', 'title' => 'Mise à jour annulée', 'message' => 'Le contact n\'a pas été ajouté. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
    ...
    public function deleteContactAction()
    {
        ...
        if($this->_request->isGet())
        {
            try {
                ...
                $this->_helper->flashMessenger(array('context' => 'error', 'title' => 'Suppression annulée', 'message' => 'Le contact n\'a pas été supprimé. Veuillez rééssayer. (' . $e->getMessage() . ')'));
            }
